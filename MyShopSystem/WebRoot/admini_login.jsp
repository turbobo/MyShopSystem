...
<html>
  <head>
    ...
    <title>My JSP 'adminilogin.jsp' starting page</title>
  ...
  <body>
    <form action="/MyShopSystem/AdminiLoginServlet.do" method="get">
  		<table class="table table-bordered table-hover " style="margin-left:20%;width:600px;">
	  		<tr><td align="center" colspan="2"><strong>管理员登录</strong></td></tr>
	  		<tr><td>管理员名</td><td><input class="btn btn-default" type="text" name="sname" id="sname" /></td></tr>
	  		<tr><td>密码</td><td><input class="btn btn-default" type="password" name="spassword" id="spassword" /></td></tr>
	  		<tr><td>验证码</td><td><img id="imgObj" alt="验证码"  src="/MyShopSystem/admini_login.jsp"  />&nbsp;</td></tr>
	  		<tr><td>输入验证码</td><td><input class="btn btn-default" type="text" name="validateCode" id="validateCode" /></td></tr>
  			<tr><td align="center" colspan="2"><input id="admini_login" class="btn btn-success" type="button" value="登录" />
  			&nbsp;&nbsp;&nbsp;&nbsp;<a href="/MyShopSystem/ListServlet.do">返回</a></td></tr>
  		</table>
  	</form>
  ...
  $("#imgObj").click(function() {  
   ...
   $("#admini_login").click(function() {  	    
	  $.ajax({
				 type: "POST", 
				 url: "AdminiLoginServlet.do", //servlet地址
